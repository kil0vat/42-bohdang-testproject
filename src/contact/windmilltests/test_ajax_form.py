...
def test_recordingSuite0():
    ...
    client.waits.forPageLoad(timeout=u'20000')
    client.waits.forElement(timeout=u'8000', id=u'id_email')
    client.click(id=u'id_email')
    client.type(text=u'dudarev@gmail.comqqqqq', id=u'id_email')
    client.click(xpath=u"//div[@id='submit-buttons']/button")
    client.click(xpath=u"//div[@id='response-modal-error']/div[3]/a")
    client.click(id=u'id_email')
    client.type(text=u'dudarev@gmail.com', id=u'id_email')
    client.click(xpath=u"//div[@id='submit-buttons']/button")
